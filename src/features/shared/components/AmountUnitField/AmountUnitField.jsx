...
import { converIntToDec, addZeroToDecimalPosition, formatKUSKAmount, parseKUSKAmount } from 'utility/buildInOutDisplay'
import { FieldLabel } from 'features/shared/components'
import pick from 'lodash/pick'

const KUSKAmountUnit = ['KUSK', 'mKUSK', 'NEU']
...
class AmountUnitField extends React.Component {
  ...
  componentDidMount() {
    if(this.props.fieldProps.value){
      this.props.fieldProps.onChange(
        parseKUSKAmount(this.props.fieldProps.value, this.state.pos )
      )
  ...
  handleChange(event) {
    ...
    if (this.props.fieldProps.onChange) {
      ...
      this.props.fieldProps.onChange(
        parseKUSKAmount(value, this.state.pos )
      )
    }
  }
      ...
      <div className='form-group'>
        ...
        <div className='input-group'>
          <input className='form-control'
            ...
            {...fieldProps}
            value={formatKUSKAmount(this.state.value, this.state.pos)}
